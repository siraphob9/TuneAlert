...
/**
 * สร้างเพลง
 * @param title คือชื่อของเพลง
 * @param artist คือชื่อของศิลปินในเพลงที่เราเลือกมา
 * @param tags หมวดหมู่ของเพลงที่เราเลือกมา
 * @throws IllegalArgumentException เมื่อ ไม่มีชื่อเพลงเพิ่มเข้ามา ไม่มีชื่อศิลปิน ไม่มีชื่อหมวดหมู่
 */
